...
if __name__ == '__main__':
    ...
    c = CardPredictor()
    c.train_svm()
    # model = ConvNet_Car_License(num_class=len(classes))
    # # caffe_model = caffe.Net('caffe_code/recognition.prototxt', 'caffe_code/recognition.caffemodel', caffe.TEST)
    ...
    for file in os.listdir(video_path):
        ...
        exist_file_path = os.path.join(save_dir, file)
        exist_file_path = exist_file_path[:-3]
        exist_file_path = exist_file_path + 'avi'
