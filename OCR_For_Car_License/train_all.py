import torch
import cv2
from dataset import Dataset_Car_License
from opts import parser
from cnn import ConvNet_Car_License
import shutil
import numpy as np
import time
...
def main():
    ...
    train_dataset = Dataset_Car_License(root_path='./data/',
                            train=True,
                            num_per_class=args.num_per_class)

    test_dataset = Dataset_Car_License(root_path='./data/',
                           train=False)

    num_class = train_dataset._get_num_class()

    model = ConvNet_Car_License(num_class=num_class)
