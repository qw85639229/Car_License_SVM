import torch
from dataset import Dataset_Number
from opts import parser
from cnn import ConvNet_Number
import shutil
import numpy as np
import time
...
def main():
    ...
    train_dataset = Dataset_Number(root_path='./data/',
                            train=True,
                            num_per_class=args.num_per_class)

    test_dataset = Dataset_Number(root_path='./data/',
                           train=False)

    num_class = train_dataset._get_num_class()

    model = ConvNet_Number(num_class=num_class)
